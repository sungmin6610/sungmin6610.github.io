...
import pandas as pd
src_data = pd.read_csv('D:/2604340036 - 송성민/Lengchain/머신러닝/회귀, 분류/머신러닝실습용자료/수박과참외.csv',encoding='cp949')
src_data
```
...
![png](/assets/images/ml/2026-06-18-ml-7-knn_files/2026-06-18-ml-7-knn_6_0.png)
...
# 모델 평가
score = knn.score(테스트용_data, 테스트용_target)
...
![png](/assets/images/ml/2026-06-18-ml-7-knn_files/2026-06-18-ml-7-knn_12_0.png)
...
![png](/assets/images/ml/2026-06-18-ml-7-knn_files/2026-06-18-ml-7-knn_13_0.png)
...
# 모델 평가
score = knn.score(테스트용_data, 테스트용_target)
print("최종 모델 정확도 :", score)

# 새로운 데이터 예측
result = knn.predict([[1000, 15]])
print("예측 결과 :", result)
```
